/**********************************************************
* File Name   : Group_Continuous_Scan_SW.c
* Module      : ADC
* Description : this file is part of the ADC example for STM32F103C8T6
* Details     : This file demonstrates the use of ADC in continuous scan mode for a group of channels with software trigger.
* Version     : 1.0.0
* Date        : 26/06/2025
...
#define HW_TRIGGER_ENABLE 0 // Enable hardware trigger for ADC
...
void Adc_Config(void)
{
    ...
    adc.ADC_ContinuousConvMode = ENABLE;   // One-shot mode for DMA
    #if HW_TRIGGER_ENABLE
    adc.ADC_ExternalTrigConv = ADC_ExternalTrigConv_T3_TRGO; // Use TIM3 trigger
    #else
