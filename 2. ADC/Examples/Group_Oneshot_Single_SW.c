/**********************************************************
* File Name   : Group_Oneshot_Single_SW.c
* Module      : ADC
* Description : This file is part of the ADC example for STM32F103C8T6
* Details     : This file demonstrates the use of ADC in one-shot single mode for a group of channels with software trigger.
* Version     : 1.0.0
* Date        : 26/06/2025
...
#define ADC_NOTIFY_ENABLE  0 // Enable notification for ADC conversion completion
...
void Adc_Config(void)
{
    ...
    adc.ADC_ScanConvMode = DISABLE;         // Single channel conversion
