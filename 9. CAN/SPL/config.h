/*
 * =============================================================================
 * Project: STM32F103 CAN Configuration Header
 * File: config.h
...
extern volatile uint8_t can_data_ready;
...
/* ======================= Global Variables ======================= */
extern CanTxMsg TxMessage;                        // CAN TX message structure
extern CanRxMsg RxMessage;                        // CAN RX message structure
extern uint8_t can_rx_buffer[CAN_RX_BUFFER_SIZE]; // Buffer to store CAN received data
extern uint8_t uart_tx_buffer[UART_TX_BUFFER_SIZE]; // Buffer for UART transmission
extern volatile uint8_t can_data_ready;           // Flag indicating new CAN data available
extern volatile uint8_t uart_dma_busy;            // Flag indicating UART DMA is busy
extern uint32_t transmission_counter;             // Transmission counter
extern uint8_t gpio_last_read;                    // GPIO last read state
