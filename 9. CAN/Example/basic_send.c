...
void CAN_Config(void)
{
    ...
    CAN_FilterInitStructure.CAN_FilterScale             = CAN_FilterScale_32bit; // 32-bit scale for simplicity
    ...
    CAN_FilterInitStructure.CAN_FilterMaskIdHigh        = 0x0000;     // TRUE accept all
    CAN_FilterInitStructure.CAN_FilterMaskIdLow         = 0x0000;     // TRUE accept all
...
void test_GPIO_A12(void)
{
    ...
    while (count--)
    {
        ...
        Delay(10000000);  // Adjust this value based on your requirements
    }
...
void USB_LP_CAN1_RX0_IRQHandler(void)
{
    ...
    if (CAN_GetITStatus(CAN1, CAN_IT_FMP0) == SET) {
        ...
        GPIOC->ODR ^= GPIO_Pin_13; // Toggle LED on message receive
