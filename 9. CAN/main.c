...
void CAN_TransmitMessage(uint8_t* data)
{
    ...
    /* Fill data payload */
    TxMessage.Data[0] = (0 >> 24) & 0xFF;  // Counter MSB
    TxMessage.Data[1] = (0 >> 16) & 0xFF;
    TxMessage.Data[2] = (0 >> 8) & 0xFF;
    TxMessage.Data[3] = 1 & 0xFF;          // Counter LSB
...
void CAN_Config(void)
{
    ...
    CAN_InitStructure.CAN_Prescaler = 4;          // Prescaler for 250kbps
